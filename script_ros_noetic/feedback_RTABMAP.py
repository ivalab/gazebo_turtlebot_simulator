...
RESULT_ROOT = "/mnt/DATA/experiments/good_graph/closedloop/xeon"
METHOD_NAME = "RTABMAP"
        ...
        for vn, fv in enumerate(Fwd_Vel_List):
            for sn, sname in enumerate(SeqNameList):
                ...
                for iteration in range(0, Num_Repeating):
                    ...
                    cmd_slam = str("bash call_rtabmap.sh" + " " + path_track_logging)
                    ...
                    for nodename in nodes:
                        ...
                        time.sleep(SleepTime * 3)
                    # subprocess.call("pkill rtabmap", shell=True)
