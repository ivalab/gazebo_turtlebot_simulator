...
SeqNameList = ["loop", "long2", "square", "zigzag", "two_circle", "infinite"]
SeqLengList = [40, 72, 105, 125, 200, 245]
...
RESULT_ROOT = "/mnt/DATA/experiments/good_graph/closedloop/12700k/multi_session/"
METHOD_NAME = "GFGG"
        ...
        for vn, fv in enumerate(Fwd_Vel_List):
            ...
            for iteration in range(Start_Iter, Num_Repeating):
                ...
                for sn, sname in enumerate(SeqNameList):
                    print(bcolors.BOLD + f"Stat sequence {sname} ..." + bcolors.ENDC)
                    path_type = sname
